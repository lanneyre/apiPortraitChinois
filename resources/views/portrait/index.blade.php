...
@section("listing")
    <h1>Listing des portraits chinois <a href="{{route("portrait.create")}}"><i class="fa-solid fa-square-plus"></i></a></h1>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{route("portrait.show", $portrait)}}"><i class="fa-solid fa-eye"></i></a></td>
                <td><a href="{{route("portrait.edit", $portrait)}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                <td>
